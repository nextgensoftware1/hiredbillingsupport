...
import bannerImage from "../../assets/images/hero/banner/Cardiology-banner.jpg"; // Import your local hero image

const CardiologyBillingHero = () => {
  return (
    <section
        ...
        <div className="row align-items-center">
          <div className="col-lg-7 col-md-10 col-12">
            <div className="pe-lg-4">
              ...
              >
                Hire Remote Cardiology Billing Experts with HBS
              </h1>
              ...
              >
                Get skilled cardiology billers, coders, and AR specialists.
                Reduce costs, speed up reimbursements, and improve billing
                accuracy with trusted remote staffing.
              </p>
...
export default CardiologyBillingHero;
