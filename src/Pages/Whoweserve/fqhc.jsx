import operationsBg from "../../assets/images/hero/fqhc.webp";
...
const OperationsServiceCards = [
  {
    ...
    title: 'FQHC Workflow Command',
    bullets: [
      'Daily command-center workflow planning and prioritization for FQHC sites',
      'Cross-functional orchestration across access, billing, and clinical operations',
      'Escalation routing for blocked, delayed, or high-risk tasks',
      'SOP adherence monitoring across all clinic locations',
      'Performance-based handoff management with accountability controls',
      'Operational continuity across clinic sites, shifts, and departments'
    ],
  },
  {
    ...
    bullets: [
      'FQHC scheduling optimization and slot governance',
      'Location-level capacity planning based on community demand',
...
const OperationsChallenges = [
  ...
  },
  {
    ...
    desc: 'Uneven provider schedules, staffing gaps, and demand spikes reduce utilization and increase wait times. We optimize FQHC-wide capacity and staffing alignment.',
  ...
  {
    title: 'Limited FQHC Visibility',
    desc: 'Without unified KPIs, leadership cannot compare performance across clinics or functions. We build real-time reporting for proactive, community-focused decisions.',
    ...
    <>
        ...
        <div className="container" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 16px' }}>
          <div className="row align-items-start">
            <div className="col-md-6">
              ...
              >
                Community-Focused | Access-Driven | Patient-Centered
              </div>
              <p
                style={{
                  fontSize: "20px",
              ...
              >
                We help Federally Qualified Health Centers optimize access, care coordination, and financial sustainability through tailored operational programs, staffing models, and performance measurement.
              </p>
              <button
                className="btn"
                style={{
      ...
      <section style={{ background: '#f8fafc', padding: '60px 0 40px 0' }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-4" style={{ fontSize: '2rem', letterSpacing: '-1px' }}>Our Approach for FQHCs</h2>
          <p className="text-center mb-5" style={{ color: '#444', fontSize: '1.08rem', maxWidth: 700, margin: '0 auto 40px auto' }}>
            Designed specifically for Federally Qualified Health Centers, our approach builds access, coordination, and sustainable operations across community care sites.
          </p>
          ...
          <div className="row justify-content-center mb-5">
            <div className="col-md-3 mb-3">
              <div className="text-center p-3">
                ...
                <p style={{ color: '#666', fontSize: '0.95rem' }}>Designed for FQHC complexity</p>
              </div>
            </div>
            <div className="col-md-3 mb-3">
              <div className="text-center p-3">
          ...
          <div className="text-center">
            <p style={{ fontSize: '1.1rem', color: '#444', fontStyle: 'italic' }}>
              Our FQHC operations model integrates with your workflows, systems, and leadership priorities to drive predictable, measurable community health performance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: '#fff', padding: '60px 0' }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-4" style={{ fontSize: '2rem', letterSpacing: '-1px' }}>Services for Federally Qualified Health Centers</h2>
          <p className="text-center mb-5" style={{ color: '#444', fontSize: '1.08rem', maxWidth: 700, margin: '0 auto' }}>
            End-to-end operations support tailored for FQHCs focused on access, care coordination, and sustainable community care delivery.
          </p>
      ...
      <section style={{ background: '#f8fafc', padding: '60px 0' }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-4">Engagement Models for FQHCs</h2>
          <p className="text-center mb-5" style={{ color: '#444', fontSize: '1.1rem' }}>Flexible delivery structures aligned to FQHC operational goals and community governance needs</p>
          <div className="row justify-content-center">
            <div className="col-12 col-md-6 col-lg-3 mb-4">
              <div className="card h-100 border-0 shadow-sm p-4" style={{ background: '#fff', borderRadius: 16 }}>
                ...
                <ul className="list-unstyled" style={{ color: '#444', fontSize: '1rem' }}>
                  ...
                  <li className="mb-2">• Best for continuous FQHC operations oversight</li>
                </ul>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3 mb-4">
            ...
            <div className="col-12 col-md-6 col-lg-3 mb-4">
              <div className="card h-100 border-0 shadow-sm p-4" style={{ background: '#fff', borderRadius: 16 }}>
                ...
                <ul className="list-unstyled" style={{ color: '#444', fontSize: '1rem' }}>
                  ...
                  <li className="mb-2">• Modular engagement with FQHC-aligned controls</li>
                </ul>
              </div>
            </div>
            <div className="col-12 col-md-6 col-lg-3 mb-4">
      ...
      <section style={{ background: '#fff', padding: '60px 0' }}>
        <div className="container">
          <h2 style={{ textAlign: 'center', fontWeight: 'bold', fontSize: '2rem', marginBottom: '14px' }}>
            Why Choose Our FQHC Operations Team?
          </h2>
          <div className="row" style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'stretch', gap: '14px', marginLeft: 0, marginRight: 0 }}>
            <CardItem icon={<FaShieldAlt />} title="Control-Driven Governance" desc="Built-in controls improve consistency, accountability, and operational risk management across FQHC clinic workflows." />
            <CardItem icon={<FaCheckCircle />} title="FQHC Healthcare Expertise" desc="Deep experience managing high-volume, multi-site community health operations and execution standards." />
      ...
      <section style={{ background: '#5DC0A7', padding: '70px 0 60px 0', color: '#fff' }}>
        <div className="container">
          <h2 className="text-center fw-bold mb-3" style={{ fontSize: '2.4rem', letterSpacing: '-1px' }}>Community Organizations We Support</h2>
          <p className="text-center mb-5" style={{ color: '#dbeafe', fontSize: '1.15rem', maxWidth: 700, margin: '0 auto' }}>
            Our services support community-focused providers, including Federally Qualified Health Centers, with multi-site operations and access priorities.
          </p>
          <div className="row justify-content-center">
            <div className="col-12 col-md-4 col-lg-3 mb-3">
              <div className="text-center p-3" style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
                <h5 style={{ fontWeight: 700, marginBottom: '8px',color: '#FFFFFF' }}>Federally Qualified Health Centers</h5>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 mb-3">
              <div className="text-center p-3" style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
                <h5 style={{ fontWeight: 700, marginBottom: '8px',color: '#FFFFFF' }}>Multi-Site Community Health Groups</h5>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 mb-3">
              <div className="text-center p-3" style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
            ...
            <div className="col-12 col-md-4 col-lg-3 mb-3">
              <div className="text-center p-3" style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
                <h5 style={{ fontWeight: 700, marginBottom: '8px',color: '#FFFFFF' }}>Behavioral Health Networks</h5>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 mb-3">
              <div className="text-center p-3" style={{ background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center">
            <div className="col-12 col-lg-6 mb-5 mb-lg-0">
              <h2 style={{ fontWeight: 700, fontSize: '2.1rem', marginBottom: 10, letterSpacing: '-1px' }}>FQHC Operations Challenges We Solve</h2>
              <p style={{ color: '#444', fontSize: '1.08rem', marginBottom: 32, maxWidth: 520 }}>
                Community health operations become complex quickly across clinics and teams. Our specialists solve the highest-impact operational barriers for FQHCs:
              </p>
            ...
            <div className="col-12 col-lg-6 d-flex align-items-center justify-content-center">
              ...
              >
                <h3 style={{ fontWeight: 700, fontSize: '1.45rem', color: '#111', marginBottom: 12 }}>
                  Ready to Modernize FQHC Operations?
                </h3>
                <p style={{ color: '#222', fontSize: '1.07rem', marginBottom: 22 }}>
                  Start with one clinical or access function or deploy a full FQHC operations framework aligned to your community health goals.
                </p>
                <ul className="list-unstyled mb-4" style={{ color: '#059669', fontSize: '1.07rem', marginBottom: 24 }}>
                  <li className="mb-2 d-flex align-items-center">
                    ...
                    Free FQHC operations assessment
                  </li>
                  <li className="mb-2 d-flex align-items-center">
                    <FaCheckCircle style={{ color: '#059669', marginRight: 10 }} />
                    Dedicated FQHC operations team
                  </li>
                  <li className="mb-2 d-flex align-items-center">
                    <FaCheckCircle style={{ color: '#059669', marginRight: 10 }} />
                  ...
                  <li className="mb-2 d-flex align-items-center">
                    <FaCheckCircle style={{ color: '#059669', marginRight: 10 }} />
                    Phased rollout from one workflow to FQHC-wide deployment
                  </li>
                </ul>
                <button
                  type="button"
                  ...
                  tabIndex="0"
                  aria-label="Book FQHC Consultation"
      ...
      <section style={{ background: "#fff", padding: "48px 0", display: "flex", justifyContent: "center" }}>
        <div style={{ maxWidth: 700, width: "100%", margin: "0 auto", background: "#fff", borderRadius: 16, boxShadow: "0 4px 24px rgba(0,0,0,0.08)", padding: "40px 32px 32px 32px", textAlign: "center", border: "1px solid #f3f4f6" }}>
          ...
          <blockquote style={{ fontSize: "1.25rem", color: "#374151", fontStyle: "italic", marginBottom: 24, lineHeight: 1.5, fontWeight: 400 }}>
            "HBS helped us operationalize a true FQHC model across five locations. We improved throughput, reduced escalation load, and gained leadership-level visibility into community health performance in under one quarter."
          </blockquote>
          ...
          <div style={{ color: "#6b7280", fontSize: "0.95rem" }}>
            FQHC Multi-Location Health Center
          </div>
        </div>
      </section>
    </>
